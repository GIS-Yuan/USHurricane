...
def edr_cloud_mask2geotiff(EDR_GEO_path, EDR_names, edr_out_dir):
    ...
    proj_str = '+proj=aea +lat_1=25 +lat_2=48 +lat_0=35 +lon_0=-90 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs'
    # East USA Aea Extent
    # area_extent left_bottom_right_top
    edr_custom_area = create_area_def('aea', proj_str, resolution=750, 
                                      units='meters', area_extent=[-2328784.272, -1643532.283764, 4125227.112702 , 1511684.573]) 
    ...
    with np.errstate(invalid='ignore'):
        edr_proj_scn.save_dataset('Cloud_mask', edr_out_path, writer='geotiff', 
                                  dtype=np.uint8, enhancement_config=False, fill_value=255)
...
if __name__ == "__main__":
    print("Start")
    input_edr_dir = r"F:\Data\US_Hurricane\VCM\VCM_2021"  # folder to restore the vcm nc file
    output_edr_dir = r"F:\Data\US_Hurricane\VCM\VCM_2021_Geotiff"  # output folder
